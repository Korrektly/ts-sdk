...
export class Korrektly {
   ...
   *
   * In browsers, this method uses fetch with the keepalive flag to ensure the tracking
   * request completes even if the user navigates away immediately after clicking.
   *
   * @param datasetId - UUID of the dataset
